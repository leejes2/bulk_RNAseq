...
fastqcr::fastqc(fq.dir = "~/data/bulk_RNA_seq/fastq_files/raw",
                qc.dir = "~/bulk_RNAseq/STEP0_fastqc_results",
                threads = 1,
...
# OPTION 1 - in R
# TO DO
system(command = "multiqc /home/prendeje/bulk_RNAseq/STEP0_fastqc_results --filename SPET0_initial_fastqc.html --outdir /home/prendeje/bulk_RNAseq/STEP0_fastqc_results/")
...
# OPTION 1 - in R
# TO DO
system(command = "cutadapt -a AGATCGGAAGAG -A AGATCGGAAGAG -q 20 --minimum-length=10 --pair-filter=any -o /home/prendeje/bulk_RNAseq/STEP1_trimmed_fastqc/30_min_N4_peptide_rep1_1_trimmed.fastq.gz -p /home/prendeje/bulk_RNAseq/STEP1_trimmed_fastqc/30_min_N4_peptide_rep1_2_trimmed.fastq.gz /home/prendeje/data/bulk_RNA_seq/fastq_files/raw/30_min_N4_peptide_rep1_1.fastq.gz /home/prendeje/data/bulk_RNA_seq/fastq_files/raw/30_min_N4_peptide_rep1_2.fastq.gz")
...
# OPTION 1 - in R
# TO DO
fastqcr::fastqc(fq.dir = "~/data/bulk_RNA_seq/fastq_files/trimmed",
                qc.dir = "~/bulk_RNAseq/STEP2_fastqc_results",
                threads = 1,
                fastqc.path = "~/software/FastQC/fastqc")
```
...
# OPTION 1 - in R
# TO DO
system(command = "multiqc /home/prendeje/bulk_RNAseq/STEP2_fastqc_results --filename STEP2_trimmed_fastqc.html --outdir /home/prendeje/bulk_RNAseq/STEP2_fastqc_results/")
